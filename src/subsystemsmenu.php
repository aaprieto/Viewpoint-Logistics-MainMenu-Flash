<?php
# @(#)$Id: subsystemsmenu.php,v 1.7 2011/09/28 15:58:24 aprarn Exp $
...
/*
*foreach ( array( 'u', 'n', 'c' , 'cd', 'ch','mh', 'app' ) as $work ) {
*/
foreach ( array( 'u', 'n','ch','mh','so', 'app' ) as $work ) { 
...
<title><?php echo $_GET['c']?> <?php echo substr($_GET['sys'], 2 , 4)?> Sub System Menu</title> 
...
<noscript>
	<object
		...
		<param name="movie"		value="SubSystemsMenu.swf" />
