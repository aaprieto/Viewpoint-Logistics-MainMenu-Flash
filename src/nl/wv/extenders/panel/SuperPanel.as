...
package nl.wv.extenders.panel {
	...
	public class SuperPanel extends Panel {
		...
		[Embed(source="../../../../css/blue_plastic.swf", symbol="resize_arrow")]
		...
		override protected function createChildren():void {
			...
			if (enableResize) {
				this.resizeHandler.width     = 18;
				this.resizeHandler.height    = 18;
		...
		public function positionChildren():void {
			if (showControls) {
				...
				this.normalMaxButton.x = this.unscaledWidth - this.normalMaxButton.width - 38;
				this.normalMaxButton.y = 6;
				this.closeButton.buttonMode	   = true;
				this.closeButton.useHandCursor = true;
				this.closeButton.x = this.unscaledWidth - this.closeButton.width - 20;
				this.closeButton.y = 6;
			}
			
			if (enableResize) {
				this.resizeHandler.y = this.unscaledHeight - resizeHandler.height - 8;
				this.resizeHandler.x = this.unscaledWidth - resizeHandler.width - 8;
			}
		}
		...
		public function closeClickHandler(event:MouseEvent):void {
			...
			this.parent.addChild(backButton);
