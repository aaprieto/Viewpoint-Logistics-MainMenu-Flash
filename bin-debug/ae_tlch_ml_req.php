<?php
# $Id: ae_tlch_ml_req.php,v 1.3 2013/06/14 18:01:34 clamat Exp $
/*****************************************************************************
	Application Environment -- Communications Hub

	Pass request from MyLogistics to server and pass response back.
...
if	(
	...
	! array_key_exists( 'MIS_ML_PORT', $_SERVER )	||
	$_SERVER['MIS_CH_HOST'] == ''			||
	$_SERVER['MIS_ML_PORT'] == 0
	) {
		ae_fnerror_log	(
...
$ae_lvwork = fwrite( $ae_lvmonsock, 'MIS_ML_REQUEST/v1/' );
